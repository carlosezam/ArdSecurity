  ...
  <div class="col">
    ...
    <div class="form-group row">
      ...
      <small class="form-text text-muted">
          Asigna un nombre a tu dispositivo que te sea mas facil de indentificar
        </small>
        <?=form_error('nombre')?>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10 col-lg-7">
      <div class="input-group">
        <input class="form-control <?=bs_is_invalid('domicilio')?>" type="text" name="domicilio" value="<?=set_value('domicilio')?>">
        <div class="input-group-addon"><i class="fa fa-map"></i></div>
      </div>
        <small class="form-text text-muted">Ingresa el domicilio donde se encuntra instalado el equipo</small>
...
<div class="modal fade" id="confirmacion" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<a class="btn btn-danger" href="<?=site_url('equipos/delete/'.set_value('id'))?>">
				Eliminar <i class="fa fa-trash"></i>
			</a>
